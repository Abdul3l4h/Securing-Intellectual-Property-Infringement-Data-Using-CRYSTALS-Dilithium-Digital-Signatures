...
Note: The code also demostrates the case where the owner modifies the file, Modified_Infringement_Data.txt, and generates a new signed file using the previously generated private key and is verified using the previous public key.
